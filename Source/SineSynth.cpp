...
#ifndef SOUL_HEADER_INCLUDED_598492220
...
public:
    ...
    struct _SparseStreamStatus
    {
        ...
        FixedArray<int32_t, 9> m_rampArray;
    };
    ...
    void Voice__run (Voice___State& _state, Voice___IO& _io) noexcept
    {
        ...
        _6 = ZeroInitialiser();
        _6.m__in_gainIn = 0;
        _6.m__in_resonanceIn = 0;
        _6.m__in_audioIn = _5.m__out_audioOut;
        Filter__run (_state.m_filter_state, _6);
        _io.m__out_audioOut = _6.m__out_audioOut;
        _7 = ZeroInitialiser();
        _7.m__in_triggerLevel = _3.m__out_note1_active;
        Envelope__run (_state.m_filterEnv_state, _7);
    }
